...
import { UserPlus, Building2, Mail, Phone, MapPin, Loader2, ArrowLeft, CheckCircle2 } from 'lucide-react';
                    ...
                    <form onSubmit={handleSubmit} className="space-y-10">
                        ...
                        <div className="grid grid-cols-1 md:grid-cols-2 gap-8 text-foreground">
                            <div className="space-y-3">
                                <Label htmlFor="name" className="text-muted-foreground font-black uppercase text-[10px] tracking-[0.2em] pl-1">Vendor/Supplier Name <span className="text-primary">*</span></Label>
                                <div className="relative">
                                    <UserPlus className="absolute left-5 top-1/2 -translate-y-1/2 h-5 w-5 text-muted-foreground" />
                                    <Input
                                        id="name"
                                        name="name"
                                        placeholder="e.g. MedSupply Pro"
                            ...
                            <div className="space-y-3">
                                ...
                                <div className="relative">
                                    ...
                                    <Input
                                        id="companyName"
                                        name="companyName"
                                        placeholder="MedSupply Global Ltd."
                                        className="h-14 bg-secondary/50 border-border rounded-2xl pl-14 pr-6 font-bold"
                        ...
                        <div className="grid grid-cols-1 md:grid-cols-2 gap-8">
                            ...
                            {/* Empty div for grid alignment since we removed category */}
                            <div></div>
                        </div>
                        ...
                        <div className="pt-6">
                            ...
                            <p className="text-center text-[10px] text-muted-foreground mt-6 font-bold uppercase tracking-[0.3em]">Stock Manager Action • Secure Data Entry</p>
                        </div>
                    </form>
                </CardContent>
            </Card>
